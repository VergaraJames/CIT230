...
// weatherAPIURL
const weatherAPIURL = `https://api.openweathermap.org/data/2.5/weather?id=id=${cityid}&APPID=${appId}&units=${units}`;
// forecastAPIURL
const forecastAPIURL = `https://api.openweathermap.org/data/2.5/forecast?id=id=${cityid}&APPID=${appId}&units=${units}`;
